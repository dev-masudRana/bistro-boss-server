...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.vu3us.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    app.get("/admin-stats", verifyToken, verifyAdmin, async (req, res) => {
      ...
      const total = payments.reduce((acc, curr) => acc + curr.price, 0);
